...
# encode dec2hex, add suffixes
HASH="$(printf '%x\n' ${PR#r})"
BUILD="$(printf '%x\n' ${PV##*_p})"
MY_PV="${PV%_p*}"
MY_P="${PN}-${MY_PV}"
#bash -c 'echo "$X $MY_PV $BUILD $HASH"'
SRC_URI="https://upwork-usw2-desktopapp.upwork.com/binaries/v${MY_PV//./_}_${HASH}/${MY_P}-${BUILD}.x86_64.rpm -> ${P}_x86_64.rpm"
...
# really not sure if any of these are still required
#	dev-libs/expat
#	dev-libs/nspr
#	dev-libs/nss
#	media-libs/alsa-lib
